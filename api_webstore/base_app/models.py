...
class Position(models.Model):  # a product's position
    ...
    brand = models.CharField(max_length=40, verbose_name='Brand', null=True, blank=True)
    description = models.CharField(max_length=500, verbose_name='Describe')
    photo = models.ImageField(upload_to="photos/%Y/%m/", verbose_name='Photo', blank=True, null=True)
