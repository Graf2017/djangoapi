...
import apps.product.utils.utils
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to=apps.product.utils.utils.categories_image_upload_path, verbose_name='Image')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='delivery', to='product.delivery', verbose_name='Delivery')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Category', to='product.categories', verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='product.position')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, upload_to=apps.product.utils.utils.image_upload_path, verbose_name='Image')),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='product.position', verbose_name='Position')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
